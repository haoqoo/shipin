...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
                ...
                <div class="datetime"><?php the_time('Y') ?><br /><?php the_time('m-d') ?></div>
					...
					<aside class="entry-meta iititle2">
                        <span><i class="icon-user icon-large"></i> <?php the_author_posts_link(); ?></span><?php printf( __( '<span><i class="icon-folder-open icon-large"></i> %2$s</span>', 'frontopen' ), 'i1', get_the_category_list( ', ' ) ); ?>
                        ...
                        <span><i class="icon-comment-alt icon-large"></i> <?php comments_popup_link( __( 'Leave a comment', 'frontopen' ), __( '1 Comment', 'frontopen' ), __( '% Comments', 'frontopen' ) ); ?></span>
                        <span><i class="icon-pencil icon-large"></i> 编辑日期：<time><?php the_modified_time('Y-m-d')?></time></span>
                        <!-- <span><i class="icon-zoom-in icon-large"></i> 字体：<a href="javascript:;" onclick="checkFontSize(18)">大</a> <a href="javascript:;" onclick="checkFontSize(16)">中</a> <a href="javascript:;" onclick="checkFontSize(14)">小</a></span><?php if(function_exists('the_views')) { the_views(); } ?> -->
						<span><i class="icon-heart-empty icon-large"></i> 评分: <?php echo get_post_meta(get_the_ID(), "like", $single = true); ?></span>						
					</aside>
