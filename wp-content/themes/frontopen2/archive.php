...
?>
    <h1 class="page-title">
<?php if ( is_day() ) : ?>
        <?php printf( __( 'Daily Archives: <span>%s</span>', 'frontopen' ), get_the_date() ); ?>
<?php elseif ( is_month() ) : ?>
        <?php printf( __( 'Monthly Archives: <span>%s</span>', 'frontopen' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'frontopen' ) ) ); ?>
<?php elseif ( is_year() ) : ?>
        <?php printf( __( 'Yearly Archives: <span>%s</span>', 'frontopen' ), get_the_date( _x( 'Y', 'yearly archives date format', 'frontopen' ) ) ); ?>
<?php else : ?>
        <?php _e( 'Blog Archives', 'frontopen' ); ?>
<?php endif; ?>
    </h1>
<?php
